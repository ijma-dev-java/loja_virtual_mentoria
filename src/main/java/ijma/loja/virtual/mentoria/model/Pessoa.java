...
public abstract class Pessoa implements Serializable { // Tabela por classes concretas
	...
	@JoinColumn(name = "empresa_id", nullable = true, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "empresa_pk"))
